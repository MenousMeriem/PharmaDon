...
function BarreRecherche({search, setSearch,searchData}) {
  return (
    <div> 
      <h1 className=' p-6 text-center text-[#203374] text-lg md:text-3xl lg:text-4xl md:py-5 mt-10 underline underline-offset-8 decoration-[#0DC4C7]'>PLONGEZ DANS L'AVENTURE DE LA RECHERCHE</h1>
      <div className='p-10 '>
        <div className='w-full h-full bg-[#0DC4C7] py-8 px-10 rounded-xl '>
            <div className='lg:flex lg:items-center lg:justify-evenly gap-2'>
                ...
                <input type="text" placeholder="Ex: nom du médicament" value={search} onChange={(e) => setSearch(e.target.value)} className="input flex-1 input-bordered border-2 border-[#0DC4C7] w-full my-2"/>
