...
function DevenirClient() {
  return (
    <div className='my-12'>
        ...
        <div className='w-full h-full lg:w-full lg:h-[600px] mx-auto relative overflow-hidden group'>
          <img src={image} className='w-full h-[400px] lg:h-full object-cover shadow-xl shadow-gray-300 bg-cover'/>
