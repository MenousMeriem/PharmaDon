  ...
  return (
    <div className='text-[#203374] bg-white border-[#0DC4C7] w-screen'>
        ...
        <div className='sm:grid sm:grid-cols-2 gap-2 sm:mt-5'>
            <div>
                <label className="label">
                    <span className="label-text text-lg font-bold text-[#203374]">Nom de la pharmacie </span>
                </label>
                {modifier ? <input type="text" className="input input-bordered border-[#203374] w-full max-w-xs" 
                value={nomPharmacieValue} onChange={e => setnomPharmacieValue(e.target.value)} /> : <h6 className="">{data.nomPharmacie}</h6>} 
            </div> 
            <div>
                <label className="label">
                ...
                {modifier ? <input type="tel" className="input input-bordered border-[#203374] w-full max-w-xs" 
                value={numPharmacieValue} onChange={e => setnumPharmacieValue(e.target.value)} /> : <h6 className="">{data.numPharmacieValue}</h6>} 
            </div>
        </div> 
        <div className='sm:grid sm:grid-cols-2 gap-2 sm:mt-5'>
            <div>
                <label className="label">
                    <span className="label-text text-[#203374]"> Wilaya de la pharmacie </span>
                </label>
                {modifier ? <select className="select select-bordered border-2 border-[#0DC4C7] w-full max-w-lg mt-2"
                ...
                </select> : <h6 className="">{data.wilayaPharmacie}</h6>}
            </div>
            <div>
                <label className="label">
                    <span className="label-text text-lg font-bold text-[#203374]"> Adresse de la pharmacie</span>
                </label>
                {modifier ? <input type="text" className="input input-bordered border-[#203374] w-full max-w-xs" 
                value={adressePharmacieValue} onChange={e => setadressePharmacieValue(e.target.value)} /> : <h6 className="">{data.adressePharmacie}</h6>}
            </div>
        </div> 
