...
function Accueil() {
  return (
    <div className='relative'>
        ...
        <Link to={'/PageProfilAssociation'}>
          <button className='bg-red-200 text-black btn'>Profil Association</button>
        </Link>
        <Link to={'/PageProfilPatient'}>
          <button className='bg-red-200 text-black btn'>Profil Parient</button>
        </Link> */}
